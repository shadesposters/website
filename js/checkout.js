...
function createCard(slug) {
  ...
  img.id = `img-${slug}`;
  img.src = `https://shadesposters.github.io/posters/${posterList[slug].filepath}`;
  img.loading = 'lazy';
  img.alt = posterList[slug].name || 'A4 Poster';
  ...
  h1.innerText = posterList[slug].name || 'A4 Poster';
